...
export function Contacts(){ 
    return(
        <div id='contacts_page'>
            <a href = 'https://www.linkedin.com/in/aina-damilola' target='_blank'className = 'contacts_page_panels' id='linkedin_panel'>
            ...
            <a href='https://github.com/aina-damilola' target='_blank' className = 'contacts_page_panels' id='github_panel'>
            ...
            <div id='contacts_preview'>
                <h1>
                    let's get in touch!
                </h1>
                <p>
                    @aina-damilola on all platforms | dami.aina@mail.utoronto.ca
                </p>
            </div>
            <a href = 'mailto:dami.aina@mail.utoronto.ca'className = 'contacts_page_panels' id='email_panel'>
